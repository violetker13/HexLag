...
import hexdoc_hexchanting

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexchantingPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexchantingModPlugin(branch=branch)


class HexchantingModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexchanting"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexchanting, "_templates"
